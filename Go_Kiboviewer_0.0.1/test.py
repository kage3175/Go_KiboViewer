...
def main() :
    ...
    while 1 :
        ...
        textSurfaceObj1 = fontObj.render('흑 사석 개수(백이 잡은 돌) : '+str(deadblack), True, BLACK)
        textRectObj1=textSurfaceObj1.get_rect();
        textRectObj1.center =(50,650)
        textSurfaceObj2 = fontObj.render('백 사석 개수(흑이 잡은 돌) : '+str(deadwhite), True, BLACK)
        textRectObj2=textSurfaceObj2.get_rect();
        textRectObj2.center =(360,650)
        pygame.display.flip()
